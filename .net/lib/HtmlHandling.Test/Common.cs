...
{
    public static void CreateFolderAndFileForTestIfNotExist(string htmlTemplateFolderWithRelativePath, string fileName, string originalHtmlTemplateFolderWithRelativePath = @"..\..\..\..\..\..\html\templateForBlog")
    {
